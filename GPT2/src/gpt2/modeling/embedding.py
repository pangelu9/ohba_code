...
class PositionalEmbedding(nn.Embedding):
    ...
    ===========================================================================
    Expl: converting input tokens (words or subwords) into dense vectors, which are also known as embeddings --
    discrete token IDs are transformed into continuous vectors that the model can work with.
    """
...
class TokenEmbedding(nn.Embedding):
    ...
    ===========================================================================
    Expl: adding positional information to the token embeddings.
    """
    def reset_parameters(self):
        nn.init.normal_(self.weight, std=0.02)
